  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      if (!isSmall) {
        ...
        tl.fromTo(lines, { yPercent: 115 }, { yPercent: 0, duration: 1.4, stagger: 0.12 }, 0.15)
        tl.fromTo(
          fades,
          { y: 28, opacity: 0 },
        ...
        <div aria-hidden style={{ position: 'absolute', inset: 0 }}>
          <div
            style={{
              position: 'absolute',
              inset: 0,
              backgroundImage: 'url(/assets/hero_bg_option2.avif)',
        ...
        >
          ...
          >
            ...
            {!isParallax && !isImage && (
              <div
                data-hero-fade
                style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: 'clamp(12px, 2vw, 20px)' }}
              >
                <Magnetic>
                  <Link
